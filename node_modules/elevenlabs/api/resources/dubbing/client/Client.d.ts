...
export declare class Dubbing {
     ...
     */
    getTranscriptForDub(dubbingId: string, languageCode: string, request?: ElevenLabs.DubbingGetTranscriptForDubRequest, requestOptions?: Dubbing.RequestOptions): Promise<unknown>;
}
